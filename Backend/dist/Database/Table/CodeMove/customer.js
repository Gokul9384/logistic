...
let customer = class customer extends _BaseTable.BaseTable {
};
_ts_decorate([
...
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], customer.prototype, "gst_number", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true
    }),
...
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], customer.prototype, "formatted_address", void 0);
customer = _ts_decorate([
    (0, _typeorm.Entity)()
], customer);
