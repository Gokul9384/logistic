...
const _Citymodel = require("../../Model/Admin/City.model");
...
let CityController = class CityController extends _JWTAuthcontroller.JWTAuthController {
    async List() {
    ...
    constructor(_CityService){
        super(), this._CityService = _CityService;
    }
};
_ts_decorate([
    (0, _common.Get)('List'),
...
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], CityController.prototype, "ById", null);
_ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _Citymodel.CityModel === "undefined" ? Object : _Citymodel.CityModel,
        String,
        String
    ]),
    _ts_metadata("design:returntype", Promise)
], CityController.prototype, "Insert", null);
_ts_decorate([
...
CityController = _ts_decorate([
    (0, _common.Controller)({
        path: "City",
        version: '1'
    }),
    (0, _swagger.ApiTags)("City"),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _Cityservice.CityService === "undefined" ? Object : _Cityservice.CityService
    ])
], CityController);
