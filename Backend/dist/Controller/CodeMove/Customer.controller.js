...
let CustomerController = class CustomerController extends _JWTAuthcontroller.JWTAuthController {
    async List() {
    ...
    constructor(_CustomerService){
        super(), this._CustomerService = _CustomerService;
    }
};
_ts_decorate([
    (0, _common.Get)('List'),
...
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], CustomerController.prototype, "ById", null);
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], CustomerController.prototype, "Insert", null);
_ts_decorate([
...
CustomerController = _ts_decorate([
    (0, _common.Controller)({
        path: "Customer",
        version: '1'
    }),
    (0, _swagger.ApiTags)("Customer"),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
