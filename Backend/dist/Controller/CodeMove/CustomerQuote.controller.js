...
Object.defineProperty(exports, "CustomerQuoteController", {
    enumerable: true,
    get: function() {
        return CustomerQuoteController;
    }
});
...
const _CustomerQuotemodel = require("../../Model/CodeMove/CustomerQuote.model");
...
let CustomerQuoteController = class CustomerQuoteController extends _JWTAuthcontroller.JWTAuthController {
    async List() {
    ...
    constructor(_CustomerQuoteService){
        super(), this._CustomerQuoteService = _CustomerQuoteService;
    }
};
_ts_decorate([
    (0, _common.Get)('List'),
...
], CustomerQuoteController.prototype, "List", null);
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], CustomerQuoteController.prototype, "ById", null);
_ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _CustomerQuotemodel.CustomerQuoteModel === "undefined" ? Object : _CustomerQuotemodel.CustomerQuoteModel,
        String,
        String
    ]),
    _ts_metadata("design:returntype", Promise)
], CustomerQuoteController.prototype, "Insert", null);
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], CustomerQuoteController.prototype, "Update", null);
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], CustomerQuoteController.prototype, "Delete", null);
CustomerQuoteController = _ts_decorate([
    (0, _common.Controller)({
        path: "CustomerQuote",
        version: '1'
    }),
    (0, _swagger.ApiTags)("CustomerQuote"),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _CustomerQuoteservice.CustomerQuoteService === "undefined" ? Object : _CustomerQuoteservice.CustomerQuoteService
    ])
], CustomerQuoteController);

//# sourceMappingURL=CustomerQuote.controller.js.map